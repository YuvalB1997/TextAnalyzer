    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (args.Length > 0)
            {
                ...
                int numberOfLetters = textAnalyzerClient.TextAnalyzerClient.LetterCount(File.ReadAllText(fileName));
                Console.WriteLine("The Number of letters is : '{0}'", numberOfLetters);
